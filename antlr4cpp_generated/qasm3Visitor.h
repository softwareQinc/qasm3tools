...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitComparisonOperator(qasm3Parser::ComparisonOperatorContext *context) = 0;

    virtual antlrcpp::Any visitEqualityOperator(qasm3Parser::EqualityOperatorContext *context) = 0;
    ...
    virtual antlrcpp::Any visitBooleanLiteral(qasm3Parser::BooleanLiteralContext *context) = 0;
